...
class Job5 {
   ...
   * @return Key value pair < asin, {unigram \t TFvalue \t TF-IDFvalue \t salesRank} >
   */
  static class Job5Mapper extends Mapper<LongWritable, Text, Text, Text> {
   ...
   * @param Text object value that is the composite key of {unigram \t TFvalue \t TF-IDFvalue \t salesRank}
   * @return Key value pair < asin, {unigram \t TFvalue \t TF-IDFvalue \t salesRank} >
   */
  static class Job5Reducer extends Reducer<Text, Text, Text, Text> {
